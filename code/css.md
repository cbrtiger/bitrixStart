...
### [Каждый селектор — на отдельной строке](#css2)
...
### [Скобки, отступы, порядок следования свойств и прочее](#css4)
...
**[less_subclass](#less_subclass)** — для удобной вставки вложенного класса или модификатора.
```xml
<snippet>
	<content><![CDATA[
&-${1:item} {
